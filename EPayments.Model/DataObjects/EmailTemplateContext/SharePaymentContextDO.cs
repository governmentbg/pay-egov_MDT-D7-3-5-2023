...
namespace EPayments.Model.DataObjects.EmailTemplateContext
{
    public class SharePaymentContextDO
    {
        ...
        public SharePaymentContextDO(string applicantName, string accessCode, string paymentRequestIdentifier, string serviceProviderName, string paymentReason, decimal paymentAmount)
        {
