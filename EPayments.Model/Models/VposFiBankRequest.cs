...
{
    public partial class VposFiBankRequest
    {
    ...
    public class VposFiBankRequestMap : EntityTypeConfiguration<VposFiBankRequest>
    {
        public VposFiBankRequestMap()
        {
            // Primary Key
            ...
            this.ToTable("VposFiBankRequests");

            this.Property(t => t.VposFiBankRequestId).HasColumnName("VposFiBankRequestId");
