...
namespace EPayments.Admin.Controllers
{
    public partial class AdminUserController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Views/AdminUser/Create.cshtml";
            public readonly string Edit = "~/Views/AdminUser/Edit.cshtml";
            public readonly string Form = "~/Views/AdminUser/Form.cshtml";
            public readonly string List = "~/Views/AdminUser/List.cshtml";
            public readonly string View = "~/Views/AdminUser/View.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AdminUserController : EPayments.Admin.Controllers.AdminUserController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, EPayments.Admin.Models.AdminUser.InternalAdminUserVM model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(EPayments.Admin.Models.AdminUser.InternalAdminUserVM model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int id, EPayments.Admin.Models.AdminUser.InternalAdminUserVM model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(int id, EPayments.Admin.Models.AdminUser.InternalAdminUserVM model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "id", id);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
