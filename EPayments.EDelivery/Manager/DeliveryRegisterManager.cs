...
using EPayments.EDelivery.EDeliveryClient;
...
{
    public class DeliveryRegisterManager : DeliveryRegisterBaseManager, IDeliveryRegisterManager
    {
        ...
        public DeliveryRegisterManager()
           : this("BasicHttpBinding_IEDeliveryIntegrationService")
        { }
        public DeliveryRegisterManager(string bidingName)
        {
        ...
        {
            return await this.RegisterService.SendMessageAsync(new EDeliveryClient.DcMessageDetails()
            {
                Title = AppSettings.EPaymentsJobHost_EventRegisterNotificationJobSPName,
                MessageText = message,
                AttachedDocuments = new EDeliveryClient.DcDocument[] { }
            },
            EDeliveryClient.eProfileType.Institution,
        ...
        public async Task<int> SendMessagePersonAsync(EserviceDeliveryNotification notification, string message, bool isInstitution = false)
        {
            ...
            isInstitution == false ? EDeliveryClient.eProfileType.Person : eProfileType.LegalPerson,
            notification.PersonUniqueIdentifier.Trim(),//eik,egn
            null,
            null,
            serviceOID: this.ServiceOID,
            operatorEGN: null);
