...
namespace EPayments.Common.Captcha
{
    ...
    public class CaptchaImage
    {
        ...
        static CaptchaImage()
        {
            ...
            TextLength = 5;
            TextChars = "2346789ABCDEFGHKLMNPRSTWXZ";
            CacheTimeOut = 600D;
        }
        ...
        /// </summary>
        public CaptchaImage(CaptchaDifficultyLevel difficultyLevel, int height, int width)
        {
            _rand = new Random();
            Width = width;
            Height = height;

            if (difficultyLevel == CaptchaDifficultyLevel.Extreme)
            {
                this.FontWarp = FontWarpFactor.Extreme;
                this.BackgroundNoise = BackgroundNoiseLevel.Extreme;
                this.LineNoise = LineNoiseLevel.Extreme;
            }
            else if (difficultyLevel == CaptchaDifficultyLevel.Medium)
            {
                this.FontWarp = FontWarpFactor.Medium;
                this.BackgroundNoise = BackgroundNoiseLevel.Medium;
